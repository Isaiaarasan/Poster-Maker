...
const Sidebar = () => {
    ...
    return (
        <div className="h-screen w-64 bg-bg-secondary border-r border-white/5 flex flex-col fixed left-0 top-0 z-50">
            {/* Logo area */}
                    ...
                    <NavLink
                        ...
                        className={({ isActive }) =>
                            `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group relative overflow-hidden ${isActive
                                ? 'bg-primary/10 text-white shadow-lg shadow-primary/5'
                    ...
                    >
                        {({ isActive }) => (
                            <>
                                ...
                                <span className={`text-lg ${isActive ? 'text-primary' : 'group-hover:text-white'}`}>
                                    {item.icon}
                                </span>
