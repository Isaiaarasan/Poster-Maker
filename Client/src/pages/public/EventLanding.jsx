                    ...
                    {step === 2 && (
                        ...
                        >
                            ...
                            <div className="space-y-4 mb-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        type="tel"
                                        placeholder="+91..."
                                        className="w-full bg-slate-100 border border-black/10 rounded-xl px-4 py-3 text-black focus:outline-none focus:border-black"
                                    />
                                </div>
                                <div>
                            ...
                            <div className="flex gap-3">
                                <button onClick={() => setStep(1)} className="px-4 py-3 rounded-xl border border-black/10 text-neutral-500 hover:text-black">Back</button>
                                <button onClick={submitLeadAndGenerate} className="flex-1 py-3 bg-black text-white font-bold rounded-xl hover:bg-neutral-800">Generate Now</button>
                            </div>
                        </motion.div>
                    )}
                    ...
                    {step === 4 && (
                        ...
                        >
                            ...
                            <div className="flex gap-2 justify-center">
                                <button onClick={() => handleShare('linkedin')} className="p-4 bg-slate-100 border border-black/10 rounded-xl text-black hover:bg-slate-200 transition-colors"><FaLinkedin className="text-lg" /></button>
                                <button onClick={() => handleShare('twitter')} className="p-4 bg-slate-100 border border-black/10 rounded-xl text-black hover:bg-slate-200 transition-colors"><FaTwitter className="text-lg" /></button>
                                <button onClick={() => handleShare('whatsapp')} className="p-4 bg-slate-100 border border-black/10 rounded-xl text-black hover:bg-slate-200 transition-colors"><FaWhatsapp className="text-lg" /></button>
                            </div>
                        </motion.div>
                    )}
